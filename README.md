...
![Version](https://img.shields.io/github/v/release/earthdawn-vtt/fvtt-earthdawn4e?label=release)

![Earthdawn Logo](assets/foundry/earthdawn-logo.png)

An implementation of the **Earthdawn Fourth Edition** game system for [Foundry Virtual Tabletop](https://foundryvtt.com).

The project is currently in **beta** and under active development. Feedback, bug reports, and feature requests are welcome through the repository’s [Issues](https://github.com/earthdawn-vtt/fvtt-earthdawn4e/issues).
...
People might use it to support the development process, under strict guidelines (see [CONTRIBUTING](/CONTRIBUTING.md).

...
export default class DialogEd extends foundry.applications.api.DialogV2 {
   ...
   * @param {Array<ItemEd|string|foundry.applications.api.DialogV2Button>} items The items to choose from. Can be a mixed array of:
   *   - ItemEd instances
   *   - UUID strings
   *   - Regular strings (used as button actions)
   *   - Complete foundry.applications.api.DialogV2Button objects
   ...
   * @returns {foundry.applications.api.DialogV2Button[]} An array of button objects.
   */
  static createItemButtons( items, buttonClass = "ed-button" ) {
    ...
    return items.map( item => {
      // foundry.applications.api.DialogV2Button object (any object with action and label)

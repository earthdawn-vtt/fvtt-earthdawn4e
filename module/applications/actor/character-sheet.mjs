...
export default class ActorSheetEdCharacter extends ActorSheetEdNamegiver {
  ...
  async _prepareContext() {
    ...
    context.buttons = [
      {
        type:     "button",
        label:    "ED.Actor.Buttons.halfMagic",
        cssClass: "halfMagic",
      ...
      {
        type:     "button",
        label:    "ED.Actor.Buttons.initiative",
        cssClass: "initiative",
      ...
      {
        type:     "button",
        label:    "ED.Actor.Buttons.knockdownTest",
      ...
      {
        type:     "button",
        label:    "ED.Actor.Buttons.recovery",
        cssClass: "recovery",
      ...
      {
        type:     "button",
        label:    "ED.Actor.Buttons.takeDamage",
        cssClass: "takeDamage",

...
export default class KnackAbilityData extends AbilityTemplate.mixin(
  ...
  //     currentLp:     actor.currentLp,
  //     currentSilver: actor.currentSilver,
  //   };
  // }
  ...
  //         fulfilled: this.requiredLpForLearning <= learnData.currentLp,
  //       },
  //       {
  //         name:      "ED.Dialogs.Legend.Validation.availableMoney",
  //         value:     this.requiredMoneyForLearning,
  //         fulfilled: this.requiredMoneyForLearning <= learnData.currentSilver,
  //       },
  //     ],

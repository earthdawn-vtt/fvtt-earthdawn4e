...
export default class KnackManeuverData extends ManeuverData.mixin(
  ...
  //   // Explicitly call the learn method from KnackTemplate
  //   return KnackTemplate.learn( actor, item, createData );
  // }

  // /** @inheritDoc */
  // get canBeLearned() {
  //   // Explicitly call the getter from KnackTemplate
  //   return KnackTemplate.prototype.canBeLearned;
  // }

  // /** @inheritdoc */
  // get learnValidationData () {
  //   // Explicitly call the getter from KnackTemplate
  //   return KnackTemplate.prototype.learnValidationData;
  // }

...
export default class EarthdawnActiveEffect extends foundry.documents.ActiveEffect {
  ...
  async addSystemChange( changeKey, changeValue, changeMode = "add", priority = null ) {
  ...
  async updateSystemChange( changeKey, changeValue, changeMode = "add", priority = null ) {
    if ( !changeKey || changeValue === undefined || changeValue === null ) {
